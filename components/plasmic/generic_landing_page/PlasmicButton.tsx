...
import sty from "./PlasmicButton.module.css"; // plasmic-import: rsiGFpz3bUbGqe/css
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <AppleIcon
                className={classNames(projectcss.all, sty.svg__rOWn)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <AppleIcon
                className={classNames(projectcss.all, sty.svg__hExLn)}
                role={"img"}
              />
            ),
