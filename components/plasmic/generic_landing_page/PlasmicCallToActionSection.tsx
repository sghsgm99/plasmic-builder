...
import sty from "./PlasmicCallToActionSection.module.css"; // plasmic-import: hgjBy0_-LO8jlZ/css
...
function PlasmicCallToActionSection__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__vfmXl)}>
        <div
        ...
        <div className={classNames(projectcss.all, sty.freeBox__olVrc)}>
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox___6MdnB)}
          >
            <p.Stack
              as={"div"}
                ...
                defaultContents: (
                  <React.Fragment>
                    <p.Stack
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__evcIx)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
                    ...
                    <p.Stack
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__o594Z)}
                    >
                      <Button
                        className={classNames(
                          "__wab_instance",
