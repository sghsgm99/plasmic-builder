...
import sty from "./PlasmicListItem.module.css"; // plasmic-import: ZCE48vaZwKhCjU/css
  ...
  return (
    ...
    >
      ...
      {p.renderPlasmicSlot({
        defaultContents: (
          <CheckCircleIcon
            className={classNames(projectcss.all, sty.svg__hfQxh)}
            role={"img"}
          />
        ),
