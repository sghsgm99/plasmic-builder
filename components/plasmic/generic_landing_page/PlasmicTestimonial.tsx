...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: uz9gt4i7Uq2It5/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__kVh5Y)}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__c9Xmq)}
      >
        <p.PlasmicImg
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__ijprN)}
        >
          <div className={classNames(projectcss.all, sty.freeBox__kWmxl)}>
            {p.renderPlasmicSlot({
